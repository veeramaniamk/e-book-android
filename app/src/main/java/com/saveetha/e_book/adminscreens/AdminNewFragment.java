...
import com.saveetha.e_book.databinding.FragmentAdminNewBinding;
...
public class AdminNewFragment extends Fragment {
    ...
    FragmentAdminNewBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAdminNewBinding.inflate(inflater, container, false);
...
//                    Toast.makeText(activity, ""+data.get(0).getBook_id(), Toast.LENGTH_SHORT).show();
